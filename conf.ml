...
module DB = struct
  ...
  (* let db_srid = 32631 *) (* WGS 84 / UTM zone 31N : projection in meters with distance in meters *)
end
...
module Evaluation = struct
  ...
  let strong = Utm.of_latlon halles
  let weak   = Utm.of_latlon boulogne
               
  let home = Utm.of_latlon champs
  let work = Utm.of_latlon defense
